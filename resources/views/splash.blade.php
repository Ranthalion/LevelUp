        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-3 col-md-offset-1">
                    <img class="img-responsive img-medium" src="img/owl_640.png" alt="">
                </div>
                <div class="col-lg-6">
            ...
            <div class="row">
                <div class="col-sm-4 portfolio-item">
                    <a href="{{ action('SkillController@index', 'woodworking') }}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/saw.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="{{ action('SkillController@index', 'Digital Fabrication') }}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/gear.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="{{ action('SkillController@index', 'technology') }}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/technology.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="{{ action('SkillController@index', 'electronics') }}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/electronics.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="{{ action('SkillController@index', 'arts') }}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/art.png" class="img-responsive" alt="">
                    </a>
                </div>
                <div class="col-sm-4 portfolio-item">
                    <a href="{{ action('SkillController@index', 'science') }}" class="portfolio-link" data-toggle="modal">
                        ...
                        <img src="img/portfolio/science.png" class="img-responsive" alt="">
                    </a>
                </div>
            </div>
        </div>
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-lg-4 col-lg-offset-2">
                    <p>Level Up is dedicating the spreading skills one person at a time.  If you know something, teach something.</p>
                </div>
                <div class="col-lg-4">
